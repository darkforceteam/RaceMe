...
//        ref = snapshot.ref
        id = snapshot.ref.key
         ...
         long_wo_no = snapshotValue[Constants.Challenge.long_wo_no] as? Int
         long_wo_dist = snapshotValue[Constants.Challenge.long_wo_dist] as? Double
    }
